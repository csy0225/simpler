 ...
 */
constexpr uint64_t PLATFORM_OP_EXECUTE_TIMEOUT_US = 60000000;  // RAISED 3s->60s (slow-vs-hang probe)
 ...
 * first.
 */
constexpr int PLATFORM_STREAM_SYNC_TIMEOUT_MS = 70000;  // RAISED 4s->70s (> op-exec 60s)
